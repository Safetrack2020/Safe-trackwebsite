...
const appCss = "/assets/styles-DnPtxxdH.css";
...
const logo = "/assets/logo-5PMycpsX.png";
const navItems = [
  { to: "/", label: "Home" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-primary text-primary-foreground rounded-b-2xl shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl flex items-center justify-between px-4 sm:px-6 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-serif text-lg sm:text-xl font-bold", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Safe Track", width: 36, height: 36, className: "rounded-full bg-white p-0.5" }),
      "Safe Track"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-8 text-sm font-semibold", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: item.to,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Facebook", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Instagram", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-5 h-5" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open, onOpenChange: setOpen, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { "aria-label": "Open menu", className: "p-2 -mr-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-6 h-6" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "bg-brand text-brand-foreground border-0 w-72", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetTitle, { className: "text-white font-serif text-xl flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "", width: 32, height: 32, className: "rounded-full bg-white p-0.5" }),
          "Safe Track"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "mt-6 flex flex-col gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: item.to,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-center gap-4 px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Facebook", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", "aria-label": "Instagram", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "w-5 h-5 text-primary" }) })
        ] })
      ] })
    ] })
  ] }) });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cream py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-2xl text-brand text-center md:text-left", children: "Our Branches" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 marquee-mask overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 w-max animate-marquee whitespace-nowrap", children: [...Array(2)].flatMap(
        (_, dup) => cities.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-brand text-brand-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-serif text-xl font-bold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "", width: 36, height: 36, className: "rounded-full bg-white p-0.5" }),
            "Safe Track"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-sm leading-relaxed opacity-90", children: [
            "No.66 | Vaani Illam,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "D.R.O.Colony Main Road, K.Pudur,",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Madurai - 7"
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-primary font-serif text-lg mb-4", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: [["Home", "/"], ["Book Taxi", "/book-taxi"], ["Tariff", "/tariff"]].map(([l, h]) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: h, className: "flex items-center gap-1 hover:text-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-primary" }),
            l
          ] }) }, h)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-primary font-serif text-lg mb-4", children: "Support" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/contact", className: "flex items-center gap-1 hover:text-primary", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-primary" }),
              "Contact Us"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/about", className: "flex items-center gap-1 hover:text-primary", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 text-primary" }),
              "About Us"
            ] }) })
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-primary font-serif text-lg mb-4", children: "Social Media" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 py-4 text-center text-xs opacity-80", children: "2025 SAFE TRACK CALL TAXI. ALL RIGHTS RESERVED" })
    ] })
  ] });
}
function Layout() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 sm:px-4 pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}) }),
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Safe Track Call Taxi — Madurai" },
      { name: "description", content: "Safe Track Call Taxi — Local, Package & Outstation taxi service across Tamil Nadu. Book a cab in seconds." },
      { name: "author", content: "Safe Track" },
      { property: "og:title", content: "Safe Track Call Taxi — Madurai" },
      { property: "og:description", content: "Safe Track Call Taxi — Local, Package & Outstation taxi service across Tamil Nadu. Book a cab in seconds." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Safe Track Call Taxi — Madurai" },
      { name: "twitter:description", content: "Safe Track Call Taxi — Local, Package & Outstation taxi service across Tamil Nadu. Book a cab in seconds." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/99951b07-3d8c-476e-adb2-6a1b024e2146/id-preview-7c047651--29407901-e3ea-4751-9247-82ed7bb28bff.lovable.app-1778925176319.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/99951b07-3d8c-476e-adb2-6a1b024e2146/id-preview-7c047651--29407901-e3ea-4751-9247-82ed7bb28bff.lovable.app-1778925176319.png" }
    ],
    links: [
...
const $$splitComponentImporter$4 = () => import("./tariff-B3E5Vy70.js");
const Route$4 = createFileRoute("/tariff")({
  head: () => ({
    meta: [{
      title: "Tariff — Safe Track Call Taxi"
    }, {
      name: "description",
      content: "Transparent fare structure for Local and Outstation trips with Safe Track Call Taxi."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-Dp01Zv_m.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Safe Track Call Taxi. Call us, email us, or visit our Madurai office."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./book-taxi-VIu6oO5h.js");
const Route$2 = createFileRoute("/book-taxi")({
  head: () => ({
    meta: [{
      title: "Book a Taxi — Safe Track Call Taxi"
    }, {
      name: "description",
      content: "Book your Local, Package or Outstation taxi with Safe Track in minutes."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-DiMZ5Ch8.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Learn about Safe Track Call Taxi — Madurai's trusted name in safe, reliable travel."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Bmh3S-_b.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Book Local, Package & Outstation taxis across Tamil Nadu with Safe Track Call Taxi."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TariffRoute = Route$4.update({
  id: "/tariff",
  path: "/tariff",
...
const BookTaxiRoute = Route$2.update({
  id: "/book-taxi",
  path: "/book-taxi",
  getParentRoute: () => Route$5
});
